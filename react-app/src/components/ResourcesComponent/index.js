...
const rows63 = [
  ...
  createData3('How to Use TypeScript Generics with Functional React Components', '', 'Tutorials'),
  createData3('How to Build a Type-Safe Todo App', '', 'Tutorials'),
  createData3('How to Use the TypeScript Satisfies Operator', '', 'Tutorials'),
  createData3('How to Build a Shopping Card with React and TypeScript', '', 'Tutorials'),
  createData3('How to Shuffle an Array of Items Using JavaScript or TypeScript', '', 'Tutorials'),
  createData3('How to Build an Image Carousel Component with TypeScript and Styled-Components', '', 'Tutorials'),
  createData3('Build and Deploy a LeetCode Clone with React, NextJS, TypeScript, Tailwind CSS, Firebase', '', 'Tutorials'),
  createData3('Full Stack Development with Next.js, TypeScript, and AWS', '', 'Courses'),
  createData3('TypeScript in React - How to Manage State with Firebase Cloud Firestore', '', 'Tutorials'),
  createData3('Create a Personal Website with Nex.js 13, Sanity.io, TailwindCSS, and TypeScript', '', 'Tutorials'),
  createData3('Learn to Code a BuzzFeed Clone in Three Ways (JavaScript, React, TypeScript)', '', 'Tutorials'),
  createData3('How to Use TypeScript in React Apps', '', 'Courses'),
  createData3('Programming in TypeScript - Full Course', '', 'Courses'),
  createData3('TypeScript for React Developers - Why TypeScript is Useful and How it Works', '', 'Courses'),
  createData3('Build a Webshop with Angular, Node.js, TypeScript, & Stripe', '', 'Tutorials'),
  createData3('Angular for Beginners Course + TypeScript', '', 'Courses'),
  createData3('How to Use TypeScript with GraphQL Using TypeGraphQL', '', 'Tutorials'),
  createData3('How to Use TypeScript - Beginner-Friendly TS Tutorial', '', 'Tutorials'),
  createData3('Build a 100 Days of Code Discord Bot with TypeScript, MongoDB, and Discord.js 13', '', 'Tutorials')
];
